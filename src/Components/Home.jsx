        ...
        <div className="col-md-9">
          <div className="row g-2">
            <div className="col-md-4">
              <div className="product py-4">
                ...
                <div classNameName="text-center">
                  {" "}
                  <img src="https://i.imgur.com/nOFet9u.jpg" width="200"></img>
                </div>
            ...
            <div classNameName="col-md-4">
              <div className="product py-4">
                {" "}
                <span classNameName="off bg-warning">SALE</span>
                <div classNameName="text-center">
                  {" "}
                  <img src="https://i.imgur.com/VY0R9aV.png" width="200" />
                </div>
                <div classNameName="about text-center">
                  <h5>Hygen Smart watch </h5> <span>$123.43</span>
                </div>
                <div classNameName="cart-button mt-3 px-2 d-flex justify-content-between align-items-center">
                  {" "}
                  <button classNameName="btn btn-primary text-uppercase">
                    Add to cart
                  </button>
                  <div classNameName="add">
                    {" "}
                    <span classNameName="product_fav">
                      <i classNameName="fa fa-heart-o"></i>
                    </span>{" "}
                    <span classNameName="product_fav">
                      <i classNameName="fa fa-opencart"></i>
                    </span>{" "}
                  </div>
                </div>
              </div>
            ...
            <div classNameName="col-md-4">
              <div classNameName="product py-4">
                <div classNameName="text-center">
                  {" "}
            ...
            <div classNameName="col-md-4">
              <div classNameName="product py-4">
                {" "}
                <span classNameName="off bg-success">-10% OFF</span>
                <div classNameName="text-center">
                  {" "}
            ...
            <div className="col-md-4">
              <div className="product py-4">
                {" "}
                <span className="off bg-success">-5% OFF</span>
